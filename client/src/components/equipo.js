...
import ImagenesEquipo from "../helper/img/imgModals/imagenesModals"
import s from "../css/equipo.css"
            ...
            <div className="cartasFooter">
                ...
                <div className="contenedorCartasPresentacionFooter">
                    ...
                    <div className="cartaPresentacionFooter">
                            ...
                            <img src={ImagenesEquipo.imagenMatthewRecortada} alt="imgprueba" className="imgCPF"></img>
                        ...
                        <button onClick={showModal} value="modalMatthew" className="botonFooterAbrirModal">Ver más</button>
                    ...
                    <div className="cartaPresentacionFooter">
                        ...
                        <img src={ImagenesEquipo.imagenTobiasRecortada} alt="imgprueba" className="imgCPF"></img>
                        ...
                        <button onClick={showModal} value="modalTobias" className="botonFooterAbrirModal">Ver más</button>
                    ...
                    <div className="cartaPresentacionFooter">
                        ...
                        <img src={ImagenesEquipo.imagenYasminRecortada} alt="imgprueba" className="imgCPF"></img>
                        ...
                        <button onClick={showModal} value="modalYasmin" className="botonFooterAbrirModal">Ver más</button>
